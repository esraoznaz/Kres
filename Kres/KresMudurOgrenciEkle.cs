...
namespace Kres
{
	public partial class KresMudurOgrenciEkle : Form
	{
		private OGRENCI_BİLGİ ogrenciBilgi;
		public KresMudurOgrenciEkle(OGRENCI_BİLGİ ogrenciBilgi)
		{
			InitializeComponent();
		...
		void OgrKaydet()
		{
			...
			using (SqlConnection con = new SqlConnection(connectionString))
			{
				...
				if (con.State == System.Data.ConnectionState.Open)
				{
					...
					cmd.Parameters.AddWithValue("@KresId", Convert.ToInt32(label_kres.Text));
					txt_id.Clear();
					txt_ad.Clear();
					txt_soyad.Clear();
					txt_yas.Clear();
		...
		private void KresMudurOgrenciEkle_Load(object sender, EventArgs e)
		{
