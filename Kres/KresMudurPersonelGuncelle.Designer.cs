namespace Kres
{
	partial class KresMudurPersonelGuncelle
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// buttonGuncelle
			// 
			this.buttonGuncelle.Location = new System.Drawing.Point(329, 409);
			this.buttonGuncelle.Name = "buttonGuncelle";
			this.buttonGuncelle.Size = new System.Drawing.Size(150, 55);
			...
			this.groupBox1.Controls.Add(this.txt_yetki);
			...
			this.groupBox1.Size = new System.Drawing.Size(389, 382);
			this.groupBox1.TabIndex = 19;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "Persoenl Güncelle";
			// 
			// richTxt_adres
			// 
			this.richTxt_adres.Location = new System.Drawing.Point(200, 173);
			this.richTxt_adres.Name = "richTxt_adres";
			this.richTxt_adres.Size = new System.Drawing.Size(121, 96);
			this.richTxt_adres.TabIndex = 23;
			...
			this.label_id.Size = new System.Drawing.Size(105, 16);
			this.label_id.TabIndex = 21;
			this.label_id.Text = "______________";
			// 
			// label12
			// 
			...
			this.label_kres.Location = new System.Drawing.Point(197, 333);
			this.label_kres.Name = "label_kres";
			this.label_kres.Size = new System.Drawing.Size(63, 16);
			this.label_kres.TabIndex = 19;
			this.label_kres.Text = "________";
			// 
			// txt_yetki
			// 
			this.txt_yetki.Location = new System.Drawing.Point(200, 277);
			this.txt_yetki.Name = "txt_yetki";
			this.txt_yetki.Size = new System.Drawing.Size(121, 22);
			this.txt_yetki.TabIndex = 18;
			// 
			// txt_ad
			// 
			...
			// txt_iletisim
			// 
			this.txt_iletisim.Location = new System.Drawing.Point(200, 116);
			this.txt_iletisim.Name = "txt_iletisim";
			this.txt_iletisim.Size = new System.Drawing.Size(121, 22);
			this.txt_iletisim.TabIndex = 12;
			// 
			// txt_email
			// 
			this.txt_email.Location = new System.Drawing.Point(200, 144);
			...
			this.label10.Location = new System.Drawing.Point(76, 305);
			this.label10.Name = "label10";
			this.label10.Size = new System.Drawing.Size(35, 16);
			this.label10.TabIndex = 9;
			this.label10.Text = "Aktif:";
			// 
			// label1
			// 
			...
			this.label9.Location = new System.Drawing.Point(76, 333);
			this.label9.Name = "label9";
			this.label9.Size = new System.Drawing.Size(51, 16);
			this.label9.TabIndex = 8;
			this.label9.Text = "Kres Id:";
			// 
			// label4
			// 
			...
			this.label8.Text = "Personel Yetki:";
			// 
			// label5
			// 
			...
			this.label5.Text = "Personel Iletisim:";
			// 
			// label7
			// 
			...
			this.Name = "KresMudurPersonelGuncelle";
			this.Text = "KresMudurPersonelGuncelle";
			this.Load += new System.EventHandler(this.KresMudurPersonelGuncelle_Load);
